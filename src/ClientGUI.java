...
public class ClientGUI extends JFrame implements ActionListener {
	...
	private JButton login, logout, whoIsIn,sendto;
	// for the chat room
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o==sendto) {
			...
			client.sendMessage(new ChatMessage(ChatMessage.SENDTO, newMess,T));
			tf.setText(" ");
			return;
		...
		if(connected) {
			...
			client.sendMessage(new ChatMessage(ChatMessage.MESSAGE, tf.getText(), null));				
			tf.setText(" ");
			return;
		}
